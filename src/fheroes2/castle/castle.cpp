...
{
    const uint32_t tavern = ( race == Race::NECR ? ( Settings::Get().PriceLoyaltyVersion() ? BUILD_SHRINE : BUILD_NOTHING ) : BUILD_TAVERN );
...
void Castle::ActionNewWeek( void )
{
    ...
    if ( world.GetWeekType().GetType() != Week::PLAGUE ) {
        const uint32_t dwellings1[] = {DWELLING_MONSTER1, DWELLING_MONSTER2, DWELLING_MONSTER3, DWELLING_MONSTER4, DWELLING_MONSTER5, DWELLING_MONSTER6, 0};
        uint32_t * dw = NULL;
        ...
        if ( world.GetWeekType().GetType() == Week::MONSTERS && !world.BeginMonth() ) {
            const uint32_t dwellings2[] = {DWELLING_MONSTER1, DWELLING_UPGRADE2, DWELLING_UPGRADE3, DWELLING_UPGRADE4, DWELLING_UPGRADE5,
...
void Castle::ActionNewMonth( void )
{
    ...
    if ( world.GetWeekType().GetType() == Week::PLAGUE ) {
        ...
        const uint32_t dwellings[] = {DWELLING_MONSTER1, DWELLING_UPGRADE2, DWELLING_UPGRADE3, DWELLING_UPGRADE4, DWELLING_UPGRADE5,
                                 DWELLING_MONSTER2, DWELLING_MONSTER3, DWELLING_MONSTER4, DWELLING_MONSTER5, 0};
        uint32_t * dw = NULL;
