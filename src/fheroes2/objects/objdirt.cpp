...
int ObjDirt::GetPassable( uint32_t index )
{
    ...
    const uint8_t restricted[] = {7,  9,  12, 13, 15, 16, 17, 18, 19, 20, 21, 22, 40, 41, 42, 43, 44, 45,  53,  54,  55,  56,  57,  58,  60,  61,  63,  64,  66,  67,  69, 71,
...
{
    const uint8_t shadows[] = {0,  1,  5,   6,   14,  47,  52,  59,  62,  65,  68,  70,  72,  75,  78,  81,  84,  87, 91,
